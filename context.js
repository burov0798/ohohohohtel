...
class TelegrafContext {
  ...
  async replyOrEdit(...args){
    ...
    try {
      let response = await this[this.updateType == "callback_query" ? "editMessageText" : "reply"](...args);
      return new Promise((r, _) => r(response));
    }catch(e){
      return this[this.updateType == "callback_query" ? "editMessageCaption" : "reply"](...args);
    }
  }
